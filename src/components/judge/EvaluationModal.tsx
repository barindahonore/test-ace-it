          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                {submission.competition.isTeamBased ?  <h3 className="font-medium">Team: {submission.team?.name}</h3> : <h3 className="font-medium">Individual: {submission.submitter?.firstName} {submission.submitter?.lastName}</h3>  }
              </div>
